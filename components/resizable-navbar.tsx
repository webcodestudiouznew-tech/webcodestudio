    ...
    <motion.div
      animate={{
        ...
        boxShadow: visible
          ...
          : "none",
        maxWidth: visible ? 1180 : 1320,
        scale: visible ? 0.975 : 1,
        y: visible ? 10 : 0,
      }}
      transition={{
        type: "spring",
    ...
    <motion.div
      animate={{
        ...
        boxShadow: visible
          ...
          : "none",
        width: "100%",
        maxWidth: visible ? 620 : 640,
        paddingRight: visible ? "12px" : "0px",
        paddingLeft: visible ? "12px" : "0px",
        borderRadius: visible ? "18px" : "32px",
        y: visible ? 10 : 0,
      }}
      transition={{
        type: "spring",
...
export const MobileNavToggle = ({
  ...
  return isOpen ? (
    <IconX className={cn("text-black dark:text-white", className)} />
  ) : (
    <IconMenu2 className={cn("text-black dark:text-white", className)} />
  );
};
...
export const NavbarLogo = () => {
  return (
    ...
    >
      ...
      />
      <span className="font-medium text-black dark:text-white">WebCode</span>
    </a>
  );
};
