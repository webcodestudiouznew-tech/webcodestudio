...
export async function AudienceSection({ locale }: { locale: string }) {
  ...
  return (
    <section
      id="audience"
      className="relative w-full scroll-mt-24 overflow-hidden bg-[linear-gradient(180deg,#23211e_0%,#1f1d1a_100%)] py-16 text-white sm:scroll-mt-28 sm:py-20 lg:scroll-mt-32 lg:py-24"
    >
