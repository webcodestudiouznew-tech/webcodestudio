  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1280px] flex-col gap-10 px-4 sm:px-6 lg:gap-14 lg:px-0">
        <Reveal className="flex max-w-[720px] flex-col items-center text-center lg:items-start lg:text-left">
        ...
        <Reveal
          className="relative overflow-hidden rounded-[28px] border border-[#8a7030]/28 bg-[radial-gradient(circle_at_top,rgba(212,175,74,0.14),transparent_38%),linear-gradient(180deg,#302712_0%,#211d17_56%,#181612_100%)] px-5 py-9 shadow-[0_28px_70px_rgba(0,0,0,0.24)] sm:rounded-[32px] sm:px-8 sm:py-11"
          delay={0.18}
          y={32}
        >
