...
export async function PricingSection({ locale }: { locale: string }) {
  ...
  return (
    <section
      id="pricing"
      className="relative w-full overflow-hidden bg-[linear-gradient(180deg,#14120f_0%,#100e0c_100%)] py-16 text-white sm:py-20 lg:py-24"
    >
              ...
              >
                ...
                <div className="mt-4 flex flex-1 flex-col">
                  ...
                  <div className="mt-2.5 grid gap-1.5">
                    {(t.raw(`plans.${plan}.items`) as string[]).map((item: string) => (
