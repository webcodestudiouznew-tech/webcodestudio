...
export async function SolutionIncludesSection({ locale }: { locale: string }) {
  ...
  return (
    <section
      ...
      className="relative w-full scroll-mt-24 overflow-hidden bg-[linear-gradient(180deg,#191714_0%,#14120f_100%)] py-16 text-white sm:scroll-mt-28 sm:py-20 lg:scroll-mt-32 lg:py-24"
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[1280px] flex-col gap-10 px-4 sm:px-6 lg:gap-14 lg:px-0">
        <Reveal className="flex max-w-[760px] flex-col items-center text-center lg:items-start lg:text-left">
        ...
        <div className="grid items-stretch gap-5 xl:grid-cols-[minmax(0,1fr)_380px]">
          <Reveal className="h-full rounded-[28px] border border-white/8 bg-[linear-gradient(180deg,rgba(255,255,255,0.04)_0%,rgba(255,255,255,0.02)_100%)] p-4 shadow-[0_22px_54px_rgba(0,0,0,0.18)] backdrop-blur-[10px] sm:p-5 lg:p-6">
            <StaggerGroup
          ...
          <div className="flex h-full flex-col gap-4 self-stretch">
            <Reveal className="flex flex-1" delay={0.12}>
